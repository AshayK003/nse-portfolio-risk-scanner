...
# diskcache.Cache is NOT thread-safe for concurrent writes by default
_CACHE_LOCK = threading.Lock()


class PriceCache:
    """Diskcache-backed L2 price cache with configurable TTL. Thread-safe for concurrent access."""
