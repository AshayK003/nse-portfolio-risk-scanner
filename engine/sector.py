...
_DEFAULT_SECTORS: dict[str, str] = {
    ...
    "AUBANK": "Banking",
        "BANDHANBNK": "Banking",
        # ETFs — classified by underlying asset class, not all lumped as "ETF"
        "NIFTYBEES": "Equity: Broad Market",
        "NEXT50IETF": "Equity: Mid Cap",
        "MIDCAPETF": "Equity: Mid Cap",
        "HDFCSML250": "Equity: Small Cap",
        "ENERGY": "Equity: Thematic",
        "MODEFENCE": "Equity: Thematic",
        "MAKEINDIA": "Equity: Thematic",
        "GOLDBEES": "Gold",
        "METALETF": "Commodities",
        "MON100": "Equity: International",
        "MOM100": "Equity: Factor",
        "QNIFTY": "Equity: Broad Market",
        "MONIFTY500": "Equity: Broad Market",
